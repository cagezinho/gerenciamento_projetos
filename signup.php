...
<body>
  ...
  <div class="container">
    ...
    <div class="form__group field">
      <form class="login" action="app/login/cadastrarUser.php" method="POST">
        <div class="inputbox">
        ...
        <input class="botao-login" type="submit" value="Create account">
      </form>
      <a class="naoTenhoConta" href="signin.php">Faça login na sua conta</a>
    </div>
  </div>
